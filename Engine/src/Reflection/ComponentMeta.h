...
#define REGISTER_COMPONENT_BEGIN(CompType) \
    static bool s_Registered_##CompType = []() -> bool { \
...
#define REGISTER_COMPONENT_PROPERTY(CompType, field) \
        _Reflect_##CompType::_Prop_##field::Register(meta);
