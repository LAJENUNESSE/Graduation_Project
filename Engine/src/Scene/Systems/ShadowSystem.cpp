...
namespace Engine
{
    ...
    // 渲染所有网格到当前绑定的深度 FBO
    static void RenderMeshesToDepth(entt::registry&         reg,
    ...
    ShadowData ShadowSystem::Execute(entt::registry&         reg,
    ...
    ShadowData ShadowSystem::ExecuteCSM(entt::registry&         reg,
                                        const LightEnvironment& lights,
