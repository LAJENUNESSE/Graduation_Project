...
namespace Engine
{
    ...
    struct ShadowData
    {
        ...
        std::array<float, CSM_MAX_CASCADES>     CascadeTexelWorldSizes{};
    };
    ...
    private:
        ...
        glm::mat4                               ComputeCascadeLightSpaceMatrix(const glm::vec3& lightDir,
                                                                               const glm::mat4& invViewProj,
                                                                               float            nearSplit,
                                                                               float            farSplit,
                                                                               float*           outTexelWorldSize = nullptr) const;
