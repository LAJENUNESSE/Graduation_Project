...
layout(std430, set = 0, binding = 3) readonly buffer RigidBodyBuffer { GPURigidBody rigidBodies[]; };
layout(std430, set = 0, binding = 10) readonly buffer MeshSDFBuffer  { GPUMeshSDFBody meshSDFBodies[]; };
layout(std430, set = 0, binding = 11) readonly buffer MeshSDFVoxelBuffer { float meshSDFVoxels[]; };
